...
plot(ecdf(norm_11_boot_res$boot))
hist(norm_11_boot_res$boot, freq = F,50)
...
plot(ecdf(norm_31_boot_res$boot))
hist(norm_31_boot_res$boot, freq = F,50)
...
plot(ecdf(norm_91_boot_res$boot))
hist(norm_91_boot_res$boot, freq = F,50)
